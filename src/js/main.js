...
class Functions {
   ...
   _slideToggle(target, duration = 500) {
      if (target.hidden) {
         return new Functions()._slideDown(target, duration);
      } else {
         return new Functions()._slideUp(target, duration);
      }
   }
}
...
class SelectConstructor {
   ...
   selectСlose(selectItem) {
      ...
      if (!selectOptions.classList.contains("_slide")) {
         ...
         new Functions()._slideUp(selectOptions, originalSelect.dataset.speed);
         setTimeout(() => {
   ...
   selectAction(selectItem) {
      ...
      setTimeout(() => {
         if (!selectOptions.classList.contains("_slide")) {
            ...
            new Functions()._slideToggle(selectOptions, originalSelect.dataset.speed);
